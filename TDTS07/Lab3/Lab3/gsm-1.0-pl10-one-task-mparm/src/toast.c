...

	  {
	    ...
	    for (k = 0; k <= 3; k++, loc_xmc += 13) {
                Gsm_Long_Term_Predictor(r,
                                      ...
                                      loc_Nc++,
                                      loc_bc++);
		dump_light_metric(6);//longterm

                Gsm_RPE_Encoding       (r,
                                      e + 5,     /* e      ][0..39][ IN/OUT */
                                      loc_xmaxc++, loc_Mc++, loc_xmc );
		dump_light_metric(7);//gsm_encoding
                {
                  register int i;
